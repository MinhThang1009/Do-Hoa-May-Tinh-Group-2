...
const properties = [
  ...
  },
  {
    ...
    description:
      "Muối có thể tác dụng với một số dung dịch acid tạo thành muối mới và acid mới. Sản phẩm tạo thành có ít nhất một chất khí, chất ít tan hoặc không tan.",
  ...
  },
  {
    ...
    description:
      "Dung dịch muối tác dụng với dung dịch bazơ tạo thành muối mới và bazơ mới, trong đó có ít nhất một sản phẩm là chất khí, ít tan hoặc không tan.",
    equation: "CuSO₄ + 2NaOH → Cu(OH)₂↓ + Na₂SO₄",
    videoUrl: "/videos/8_Na2SO4+BaCl2.mp4",
    ...
    <div className="min-h-screen page-enter pb-24">
      <div className="container mx-auto px-4 mt-8">
        <header className="text-center mb-16 relative">
          ...
          <SplitTextTitle
            text="Tính Chất Hóa Học"
            className="text-5xl md:text-6xl font-extrabold mb-4"
          />
          <p className="text-lg text-[var(--muted)] max-w-2xl mx-auto leading-relaxed">
            Khám phá 4 tính chất hóa học cơ bản của muối thông qua các thí
            nghiệm trực quan.
          </p>
        </header>
          ...
          {properties.map((prop, idx) => (
            ...
            >
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, rgba(${prop.rgb}, 0.06), transparent 60%)`,
                }}
              >
                {/* Videos Row */}
                <div
                  className="flex flex-col lg:flex-row border-b"
                  style={{ borderColor: `rgba(${prop.rgb}, 0.16)` }}
                >
                  {/* Real Video */}
                  <div
                ...
                <div className="w-full p-7 lg:p-10 flex flex-col lg:flex-row items-start gap-8">
                  <div className="w-full lg:w-1/2">
                    ...
                    >
                      <span
                        className="text-xs font-semibold uppercase tracking-wider block mb-2 opacity-70"
