    ...
    <div className="min-h-screen page-enter">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16 animate-fade-in-up stagger-3">
        ...
        <div className="mb-20">
          <div className="flex items-center gap-4 justify-center mb-10">
            <h2 className="text-4xl font-extrabold text-[var(--text)]">Bài 8: Acid</h2>
          </div>
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-7">
            {acidChapters.map((chapter, index) => (
              <Link
                key={index}
                to={chapter.path}
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <h3 className="text-xl font-bold text-[var(--text)] mb-3 transition-colors group-hover:text-[var(--accent)]">
